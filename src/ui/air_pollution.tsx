...
import { AirPollutionType } from "@/lib/definitions";
...
export default function AirPollution({
  ...
  return (
    <div className="order-2 col-span-2 flex flex-col px-4">
      <CardHeader>
        <CardTitle>
          <i>
            <svg
      ...
      <CardContent className="my-auto">
        <Progress
          ...
          value={airPollution.main.aqi * 10}
        />
      </CardContent>
      <CardFooter>
        <p>
          {airPollution.main.aqi < 50
            ? "Air quality is good."
            : airPollution.main.aqi < 100
            ? "Air quality is moderate."
            : airPollution.main.aqi < 150
            ? "Air quality is unhealthy for sensitive groups."
            : airPollution.main.aqi < 200
            ? "Air quality is unhealthy."
            : airPollution.main.aqi < 300
